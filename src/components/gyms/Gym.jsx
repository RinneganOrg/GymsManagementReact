      ...
      {gymToDisplay ? (
        <>
          <Grid className="gym-grid">
            ...
            <Grid.Column width={3}>
              <Header as="h1" className="gym-header">
                {gymToDisplay.name}
              </Header>
              <Divider />
              <List size="maassive">
                <List.Item className="gym-icon">
                  <Image
                    avatar
                    size="mini"
                    src="https://icon-library.com/images/weight-lifting-icon/weight-lifting-icon-12.jpg"
                  />
                  <List.Content>
                    <List.Header className="list-header-gym">
                      Strenght
                    </List.Header>
                  </List.Content>
                </List.Item>
                <List.Item className="gym-icon">
                  <Image
                    avatar
                    size="mini"
                    src="https://i.pinimg.com/favicons/c6f00f8d1530320fd05c4d4c6f12e5e076d7efa0d1a97956d528c936.png?592630392bec75ce2d448ffa008a719d"
                  />
                  <List.Content>
                    <List.Header className="list-header-gym">
                      Cardio
                ...
                <List.Item className="gym-icon">
                  <Image
                    avatar
                    size="mini"
                    src="https://cdn.iconscout.com/icon/free/png-256/swimming-man-swim-activity-swimmer-pool-sport-46453.png"
                  />
                  <List.Content>
                    <List.Header className="list-header-gym">
                      Swimming
            ...
            <Grid.Row>
              <Header as="h5" className="gym-header">
                {gymToDisplay.description}
              </Header>
            </Grid.Row>
          </Grid>
          ...
          {displayedSection === "calendar" ? (
            ...
            <>
              <Graphs gymId={gymId} modal={ModalActivity} />
            </>
          ) : (
